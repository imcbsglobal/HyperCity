    ...
    <div className=' mt-10'>
      <div className=' flex justify-center items-center gap-5'>
        {categoryList.map((item)=>(
            <div className='w-[60px] h-[60px] rounded-full flex flex-col justify-center items-center gap-2 cursor-pointer '>
                {/* Category Image */}
                <div className='xmd:w-[60px] w-[40px] h-[40px] xmd:h-[60px] rounded-full shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>
