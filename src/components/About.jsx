        ...
        <div className=''>
          <div className=' px-6 lg:w-[1200px] llg:w-[1400px] lg:mx-auto mt-2 mb-10 lg:flex lg:flex-row-reverse lg:gap-10'>
            ...
            <div className='lg:w-[60%]'>
              ...
              <div className=' mb-5'>The Hypercity Hypermarket was established on 2nd May 2019 in Kamblakkad, Wayanad, Kerala. We are committed to providing maximum quality products at minimum prices, drawing on over 20 years of experience in the grocery industry. Noufal KK, having channeled his deep market knowledge and expertise from his previous venture, Naas Agencies, a wholesale sugar dealership serving both Wayanad and Kannur districts, expanded into the grocery retail sector. Together with his brothers, Noufal began their successful retail journey in the Kannur district. The grand opening of the first Hypercity Hypermarket was inaugurated by Panakkad Sayyid Basheer Ali Shihad Thangal, and it quickly became a trusted name among customers.
              </div>
              <div className=' mb-7'>
